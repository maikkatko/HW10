...
/**
 * This class implements the ICommand interface for a green component greyscale transformation.
 * This involves parsing a scanner for the data needed and then calling the greenTransform strategy.
 */
public class GreenCommand implements ICommand {
  ...
  public void run(Scanner scanner, IModel model, IView view) {
    ...
    IImageState greenImage = filterTransform.apply(sourceImage);
