...
/**
 * This class implements the ICommand interface for a red component greyscale transformation.
 * This involves parsing a scanner for the data needed and then calling the redTransform strategy.
 */
public class RedCommand implements ICommand {
  ...
  public void run(Scanner scanner, IModel model, IView view) {
    ...
    IImageState redImage = filterTransform.apply(sourceImage);
